...
function apollo_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'apollo_content_width', 640 );
}
...
function apollo_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'apollo' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'apollo' ),
...
function apollo_scripts() {
	...
	wp_enqueue_script( 'apollo-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'apollo-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
